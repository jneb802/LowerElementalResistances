...
namespace Lower_Player_Resistances
{
    ...
    public class Lower_Player_ResistancesPlugin : BaseUnityPlugin
    {
        internal const string ModName = "Lower_Player_Resistances";
        ...
        public static readonly ManualLogSource Lower_Player_ResistancesLogger = BepInEx.Logging.Logger.CreateLogSource(ModName);
        ...
        private void ReadConfigValues(object sender, FileSystemEventArgs e)
        {
            ...
            try
            {
                Lower_Player_ResistancesLogger.LogDebug("ReadConfigValues called");
                Config.Reload();
            }
            catch
            {
                Lower_Player_ResistancesLogger.LogError($"There was an issue loading your {ConfigFileName}");
                Lower_Player_ResistancesLogger.LogError("Please check your config entries for spelling and format!");
            }
        }
